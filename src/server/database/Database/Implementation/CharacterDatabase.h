...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_CHAR_MULTICLASS_LOADOUT,
    CHAR_INS_CHAR_MULTICLASS_LOADOUT,
    CHAR_UPD_CHAR_MULTICLASS_LOADOUT_NAME,
    CHAR_DEL_CHAR_MULTICLASS_LOADOUT_ONE,
    CHAR_DEL_CHAR_MULTICLASS_LOADOUT,
    CHAR_DEL_CHAR_MULTICLASS_LOADOUT_SLOT,
    CHAR_DEL_CHAR_MULTICLASS_LOADOUT_TALENT,
    CHAR_DEL_CHAR_MULTICLASS_LOADOUT_GLYPH,
