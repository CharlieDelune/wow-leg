...
enum ServerConfigs
{
    ...
    CONFIG_TALENTS_RESET_DECAY_DAYS,
    ...
    CONFIG_MULTICLASS_ENABLE,
    CONFIG_MULTICLASS_MAX_ACTIVE_CLASSES,
    CONFIG_MULTICLASS_COMBINED_STATS,
    CONFIG_MULTICLASS_DIEGETIC_CLASS_NAME,
