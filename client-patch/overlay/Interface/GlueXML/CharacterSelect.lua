...
function UpdateCharacterList()
	...
	for i=1, numChars, 1 do
		...
		if ( not name ) then
			...
			if( ghost ) then
				_G["CharSelectCharacterButton"..index.."ButtonTextInfo"]:SetFormattedText(CHARACTER_SELECT_INFO_GHOST, level, "Adventurer");
			else
				_G["CharSelectCharacterButton"..index.."ButtonTextInfo"]:SetFormattedText(CHARACTER_SELECT_INFO, level, "Adventurer");
			end
...
function CharacterDeleteDialog_OnShow()
	...
	CharacterDeleteText1:SetFormattedText(CONFIRM_CHAR_DELETE, name, level, "Adventurer");
